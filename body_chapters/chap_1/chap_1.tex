...
Creating these tests also requires effort to gather the inputs to the test, and
...
test may also change. ExploTest attempts to cheaply remedy this by automating the input collection and assertion creation.
